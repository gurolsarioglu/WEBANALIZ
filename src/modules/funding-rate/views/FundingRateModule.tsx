    ...
    if (!liveData) {
        return (
            <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-400 mb-4">💰 Funding Rate</h3>
            ...
            <div className="space-y-4">
                ...
                {liveData.coinRank && (
                    <div className="bg-gray-900/50 rounded-lg p-3">
                        <div className="text-gray-400 text-sm mb-1">Top Gainers Sıralaması</div>
                ...
                <div>
                    ...
                    <div className="space-y-1">
                        {liveData.topGainers.slice(0, 5).map((gainer, index) => (
                            <div key={index} className="flex justify-between items-center bg-gray-900/50 rounded px-3 py-2 text-sm hover:bg-gray-900/70 transition-colors">
